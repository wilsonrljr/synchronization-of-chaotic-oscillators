...
y2    = load('xlor_k=20.dat');
y5    = load('xlor_k=25.dat');
...
x2    = load('xlor_ext_k=20.dat');
x5    = load('xlor_ext_k=25.dat');
...
legend('LBE Lorenz for k=0','LBE Lorenz for k=15','LBE Lorenz for k=20','LBE Lorenz for k=25','LBE Lorenz for k=30');
